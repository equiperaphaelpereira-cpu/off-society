...
window.OFF_AUDIOS = {
  ...
  a7: {
    ...
    src: '',
    title: 'Off Society',
    text: 'Foi por isso que eu criei a Off Society. É a minha comunidade fechada. Lá eu ensino do zero absoluto: o que é dólar, o que é bitcoin, como escolher uma corretora segura, até as estratégias que eu uso. E de segunda a sexta a gente tem um meet fechado, ao vivo, onde eu opero na minha conta explicando cada decisão, mostrando os dias bons e os dias ruins. No final de todo meet, você pode me fazer perguntas.',
    textChat: 'É a minha comunidade fechada. Lá eu ensino do zero absoluto: o que é dólar, o que é bitcoin, como escolher uma corretora segura, até as estratégias que eu uso. E de segunda a sexta a gente tem um **meet fechado, ao vivo**, onde eu opero na minha conta explicando cada decisão, mostrando os dias bons e os ruins. No final de todo meet, você pode me fazer perguntas.'
  },
  a8: {
    file: 'a8-preco',
    src: '',
